...
class OrderPage:
    ...
    def hover_product1(self):
        ...
        actions.move_to_element(product1).move_to_element(add_tocart).click().perform()
    ...
    def hover_product2(self):
        ...
        actions = ActionChains(self.driver)
        actions.move_to_element(product2).move_to_element(add_tocart2).click().perform()
    ...
    def hover_product3(self):
        ...
        actions = ActionChains(self.driver)
        actions.move_to_element(product3).move_to_element(add_cart).click().perform()

    def total_price(self):
        list_total_product_price = self.driver.find_elements_by_xpath(self.list_total_product_price_xpath)  # list elt
        list_price = []
    ...
    def input_email(self, input_key):
        self.driver.find_element_by_xpath(self.email_checkout_xpath).send_keys(input_key)

    def input_pass(self, password):
        self.driver.find_element_by_xpath(self.pass_checkout_xpath).send_keys(password)
    ...
    def hover_product4(self):
        ...
        actions = ActionChains(self.driver)
        actions.move_to_element(product4).move_to_element(add_cart).click().perform()
    ...
    def hover_product5(self):
        ...
        actions = ActionChains(self.driver)
        actions.move_to_element(product5).move_to_element(add_cart).click().perform()
    ...
    def choice_random(self, list_deleted, value):
        lst_product = self.driver.find_elements_by_xpath(self.random_product_xpath)
    ...
    def delete_random(self, list_deleted):
        lst_product = self.driver.find_elements_by_xpath(self.random_delete_xpath)
