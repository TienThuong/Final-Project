...
class ContactUS:
    ...
    def set_upload(self):
        self.driver.find_element_by_id(self.input_fileup_id).send_keys('C:/Users/Administrator/Pictures/1.jpg')

    def set_message(self, message):
        self.driver.find_element_by_id(self.input_message_id).send_keys(message)
